...
export function Wordmark({ className = "" }: { className?: string }) {
  return (
    <span className={`catalog-latin text-[1.15rem] font-medium tracking-tight text-slate-900 ${className}`} dir="ltr">
      Whats<span className="font-extrabold text-blue-600">Unity</span>
    </span>
  );
}
